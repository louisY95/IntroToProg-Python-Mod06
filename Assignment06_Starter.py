...
# <LYencken>,<08/11/2020>,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def write_data_to_file(file_name, list_of_rows):
        ...
        for line in list_of_rows:
            objFile.write(line["Task"] + ',' + line["Priority"] + '\n')
        objFile.close()
        return list_of_rows, 'Success'
...
class IO:
    ...
    def input_new_task_and_priority():
        ...
        task = str(input("What task is to be added: ")).lower().strip()
        priority = str(input("What is the priority: ")).lower().strip()
        return task, priority

    @staticmethod
    def input_task_to_remove():

        task = str(input("What task do you want removed: ")).lower().strip()
        return task
